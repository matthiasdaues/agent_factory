...
impact:
  ...
  boundaries:
    ...
    - .agent-factory/factory/rulebooks/schemas/research-survey-plan.schema.json
...
Dispatch follows the [dispatch-contract](../../../.agent-factory/factory/rulebooks/conventions/dispatch-contract.md):
