...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | -------- |
| Claude, Codex, and Copilot background captures are invisible to the removal fence; reuse the existing supervised generation handoff for these adapters and add one uninstall-race regression per adapter. | `.agent-factory/factory/config/hooks/capture-usage.sh:68`; `.agent-factory/factory/config/hooks/capture-codex-usage.sh:35`; `.agent-factory/factory/config/hooks/capture-copilot-usage.sh:33`; `factory/scripts/remove-factory:423` | Defect   | Major    |
