...
`.agent-factory/factory/config/extensions/dispatch-wave.ts`, its canonical blocked-wave report,
...
per-item diagnostics to `.agent-factory/factory/reports/dispatch-wave-blocked.md`, force-adds
