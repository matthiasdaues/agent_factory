...
| Blocked-wave result durability             | BR-040 non-empty canonical tracked-artifact requirement                 | `persistBlockedWaveReport`; `.agent-factory/factory/reports/dispatch-wave-blocked.md`; blocked-path regression | Match  | `FAGAN-0011` remains resolved; no spec change |
