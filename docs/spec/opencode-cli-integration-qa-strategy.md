...
| opencode --version not found on PATH           | Scenario: Installer rejects an unsupported OpenCode version       | Installer crashes instead of reporting       | Contract test    | Verify graceful failure with upgrade instruction |
