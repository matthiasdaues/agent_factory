...
| Human Operator  | Configure risk classes per project in testing.yaml                   | Rule: Human Operator configures risk classes per project in testing.yaml       | specified |
| Human Operator  | Configure gate thresholds centrally in testing.yaml                  | Rule: Human Operator configures gate thresholds in testing.yaml                | specified |
...
| 6    | testing.yaml gates and risk_classes sections                   | Rule: Human Operator configures gate thresholds; Rule: Human Operator configures risk classes                      |
...
| 15   | testing.yaml template has risk_classes example                 | Rule: Human Operator configures risk classes per project (Scenario: Template includes risk_classes schema)         |
