...
| Template includes gates and risk_classes         | `Scenario: Template includes risk_classes schema by example`             | Deterministic linter | TD-LN-03 | `.agent-factory/factory/rulebooks/templates/charter-testing.yaml` | visual inspection                         | planned |
