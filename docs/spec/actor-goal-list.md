...
- **CLI-Invoked Agent** (secondary) — the Claude Code or Copilot CLI session `trigger` dispatches; a supporting actor with no goal of its own beyond executing the agent definition it was handed.
