...
5. **ST-0101 branch confusion:** `story/ST-0101` is at feature branch HEAD (`6c6dea6`), not at its base — it was apparently rebased or reset by the stale agent. No crap-score implementation exists. The fixture directory `.agent-factory/factory/fixtures/quality-gates/high-crap/` exists with `src/` and `tests/` subdirs but SKILL.md and script are missing. Delete the branch and recreate from the feature branch tip before implementing.
...
| ------- | -------------------------------------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| ST-0094 | Amend testing-strategy.md                                | done    | `.agent-factory/factory/rulebooks/conventions/testing-strategy.md` amended                                                                        |
| ST-0095 | Amend cross-reference-format.md + validate enforcement   | done    | `.agent-factory/factory/rulebooks/conventions/cross-reference-format.md` has `@`-ref section; `.agent-factory/factory/scripts/validate` has check |
| ST-0096 | Create derive-feature skill                              | done    | `.agent-factory/factory/skills/derive-feature/SKILL.md` exists                                                                                    |
| ST-0097 | Create qa-strategy-from-spec skill                       | done    | Merged at `6c6dea6`; `.agent-factory/factory/skills/qa-strategy-from-spec/SKILL.md` (207 lines)                                                   |
| ST-0099 | Create scope-map-migration skill                         | done    | `.agent-factory/factory/skills/scope-map-migration/SKILL.md` exists (commit `8c5a8f9`)                                                            |
| ST-0100 | Add quality-gates field to story.md template             | done    | Merged at `0d6452e`; `.agent-factory/factory/rulebooks/templates/story.md` has `quality-gates` field                                              |
| ST-0101 | Create crap-score gate skill, script, and fixture        | pending | Fixture `.agent-factory/factory/fixtures/quality-gates/high-crap/` exists; SKILL.md and script missing                                            |
...
- .agent-factory/factory/skills/derive-feature/SKILL.md
- .agent-factory/factory/skills/qa-strategy-from-spec/SKILL.md
- .agent-factory/factory/skills/scope-map-migration/SKILL.md
- .agent-factory/factory/rulebooks/templates/story.md
- .agent-factory/factory/fixtures/quality-gates/high-crap/
- backlog/ST-0094.md
- backlog/ST-0095.md
- backlog/ST-0096.md
- backlog/ST-0097.md
...
Gates: `.agent-factory/factory/scripts/premerge-check feature/agentic-quality-gates-and-specification-consolidation story/ST-0097` passed after rebase. ST-0100 premerge passed (merged at `0d6452e`). No gates run on ST-0101, ST-0102, ST-0103 (not yet implemented or not yet merged).
...
2. Merge ST-0103: rebase `story/ST-0103` onto the feature branch, run `.agent-factory/factory/scripts/premerge-check`, merge with `--no-ff`.
