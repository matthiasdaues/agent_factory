...
- [Orchestrator](../../orchestrator/README.md) — the thin Python CLI that drives the agent chain, running steps or whole chains with deterministic gates and human approval at phase gates. See also [orchestrator docs](../../orchestrator/docs/) and [orchestrator ADRs](../../orchestrator/docs/adr/).
