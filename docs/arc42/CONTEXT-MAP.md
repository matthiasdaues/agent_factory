...
- [Orchestrator](../../orchestrator/README.md) — the thin Python CLI that drives the agent chain, running steps or whole chains with deterministic gates and human approval at phase gates. (Work in progress — not yet operational.) See also [orchestrator docs](../../orchestrator/docs/) and [orchestrator ADRs](../../orchestrator/docs/adr/).
...
database availability never blocks Factory capture. Orchestrator remains
independent. Factory API has no implemented integration.
