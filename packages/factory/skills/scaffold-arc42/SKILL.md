...
Create the following under `docs/`. Keep `README.md` as the only file directly
in `docs/`; arc42 prose and the Structurizr source live in `docs/arc42/`, while
the existing supporting folders remain unchanged:
