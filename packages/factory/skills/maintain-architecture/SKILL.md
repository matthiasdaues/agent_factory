...
Format every updated chapter via `.agent-factory/factory/scripts/mdformat --number <path>` per [markdown-formatting.md](../../rulebooks/conventions/markdown-formatting.md).
...
```bash
.agent-factory/factory/scripts/statemachine-lint --spec-dir docs/spec
```
