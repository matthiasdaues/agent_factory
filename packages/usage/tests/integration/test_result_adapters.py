...
class TestArrowAdapter:
    ...
    def test_preserves_null(self, tmp_path: Path) -> None:
        import pyarrow
        rec = {
            "record_id": "r1", "project_id": "proj-test", "project_name": "test",
            "normalized_input": 100, "normalized_output": 50, "normalized_total": 150,
            "cli": "pi", "session_id": "s1", "parent_session_id": None, "depth": 0,
            "recorded_at": "2026-01-15T10:00:00Z", "agent": "a", "model": "m",
            "provider": "p", "reported_input": 10, "reported_output": 5,
            "reported_cache_read": None, "reported_cache_write": None,
            "usage_granularity": "turn", "usage_capability": "full",
            "cache_miss_turns": None, "cache_miss_input_tokens": None,
            "late_early_input_ratio": None, "exit_status": "success",
