...
3. **Track action items** — Present confirmed items; ask the user where each is tracked (`docs/spec/todos.md` as a new T-NNNNNN, issue tracker, agent/skill update, `docs/arc42/CONTEXT.md` if it's vocabulary/process, or backlog story (`backlog/ST-NNNNNNN.md`) dispatched to `implementation-agent`).
