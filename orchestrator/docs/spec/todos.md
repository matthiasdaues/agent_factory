...
| T-20 | **Per-project model policy override** (a project supplies its own policy block over the shared matrix facts)                                                                 | Deferred, mid/long-term (Q4). Facts/policy are kept separate in the matrix so this is an additive change.                                                                                                                                                                                          |
