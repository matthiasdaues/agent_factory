...
5. **Address review findings** (repeat passes) — Re-run steps 1–4 as needed for open `SPEC-*` findings. Commit per [commit-conventions.md](../rulebooks/commit-conventions.md): `docs: <description> (SPEC-NNNN)`.
